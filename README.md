...
```bash
npm install && cp .env.example .env  # Add FIRECRAWL_API_KEY to .env
npm run dev                           # Open http://localhost:3000
```

---

Built by [Flowful.ai](https://flowful.ai) | Check your site's AI readiness at [GEO Ready](https://geo-ready.flowful.ai)
